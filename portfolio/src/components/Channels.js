...
function Channels({setChannel, sidebarStatus, setSideBarStatus}){
    ...
    useEffect(()=>{
        ...
        function expandSideBar(){
            ...
            const HeaderInitialClass =  " none fixed xs:w-screen lg:w-80 lg:h-0 bg-gray-800 border-b border-gray-800 shadow-md items-center justify-center transition-all 1s opacity-0"
